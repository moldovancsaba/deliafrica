...
function fromStatic(product) {
  ...
  return {
    ...
    story: product.story || details.summary || '',
    whatItIs: product.whatItIs || details.what || '',
    background: product.background || details.background || '',
    flavour: product.flavour || details.flavour || '',
    audience: product.audience || details.suits || '',
    packaging: product.packaging || details.info || '',
    info: product.info || details.info || '',
    originCountry: 'South Africa',
    brand: product.brand || '',
    ingredients: '', allergens: '', storage: details.storage || '', nutrition: '',
    pairings: product.pairings || details.uses || [],
    servingIdeas: product.servingIdeas || details.serving || [],
