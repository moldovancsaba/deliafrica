...
import { DEFAULT_SITE_SETTINGS, DEFAULT_STOREFRONT_CONTENT, DEFAULT_SALES_SETTINGS, DEFAULT_LEGAL_SETTINGS } from '@/lib/site-config';
...
export async function getSiteSettings() {
  ...
  if (!mongo.connected) return { ...DEFAULT_SITE_SETTINGS, uiCopy: DEFAULT_STOREFRONT_UI_COPY };
