...
export default async function ProductPage({ params }) {
  ...
  return <main className="product-page">
    ...
    <section className="product-content">
      ...
      <figure className="product-editorial"><Image src={item.editorialImage} alt={`${item.categoryName} tálalási hangulat`} fill sizes="(max-width: 650px) 100vw, 88vw"/><figcaption>Dél-afrikai ihletésű tálalási hangulat · illusztráció</figcaption></figure>
    ...
    <footer><BrandLogo inverse /><p>Budapest · Hungary<br />deli.africa v{APP_VERSION}</p><div><Link href="/#shop">Shop</Link><Link href="/dashboard">System dashboard</Link></div></footer>
  </main>;
}
